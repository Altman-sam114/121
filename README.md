...
- 当前阶段只做官渡小地图默认入口、兼容显示层、多势力数据表达、初始外交 profile、三国兵种模板兼容层和战术审计显示三国化；完整多势力 turn order、完整官渡大地图、围城、正式君主/军师/武将 Agent 将按 v2.3+ 分阶段推进。
