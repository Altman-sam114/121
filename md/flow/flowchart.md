...
flowchart TD
    ...
    GIP["武将影响面板摘要<br/>AppContainer.selectedGeneralInfluenceNotes<br/>道路机动 + 接敌攻防 + 近敌对象只读展示"]:::ui
