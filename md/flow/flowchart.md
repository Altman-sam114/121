...
flowchart TD
    ...
    POM["地图计划军令标识<br/>BoardScene 读取 PlayerPlannedOperation<br/>源/目标点 + 进攻箭头/固守环 + 武将/战术/官道受压短标签"]:::ui
...
flowchart TD
    ...
    BOARD["视觉反馈<br/>BoardScene<br/>进攻箭头、防御圆环、武将战术/官道受压短标签、微操单位金色圈"]:::ui
