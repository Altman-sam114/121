...
flowchart TD
    ...
    GIP["武将影响面板摘要<br/>GeneralCommandPanelView<br/>道路机动 + 官道受益/无加成原因 + 接敌攻防 + 接敌配对 + 近敌对象 + 目标预览 + 麾下备战 + 灰态原因"]:::ui
