...
flowchart TD
    ...
    RRP["郡县态势摘要<br/>RegionInspectorState / RegionInspectorView<br/>官道覆盖 + 当前地格官道 + 敌对/非敌对军队"]:::ui
