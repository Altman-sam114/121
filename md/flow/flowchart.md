...
flowchart TD
    ...
    UCP["军队接战预判<br/>AppContainer.selectedUnitCombatPreviewNotes<br/>预计伤害 + 反击 + 武将影响 + 交战审计"]:::ui
