...
flowchart TD
    ...
    POM["地图计划军令标识<br/>BoardScene 读取 PlayerPlannedOperation<br/>源/目标点 + 进攻箭头/固守环 + 武将/战术短标签"]:::ui
