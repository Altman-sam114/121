...
flowchart TD
    ...
    GIP["武将影响面板摘要<br/>GeneralCommandPanelView<br/>道路机动 + 官道受益军队 + 接敌攻防 + 接敌配对 + 近敌对象 + 麾下备战"]:::ui
