...
flowchart TD
    ...
    UCP["军队接战预判<br/>AppContainer.selectedUnitCombatPreviewNotes<br/>首选理由 + 三目标排序 + 敌我余兵 + 目标态势 + 撤退/歼灭风险 + 首选武将影响 + 交战审计"]:::ui
