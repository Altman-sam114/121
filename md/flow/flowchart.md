...
flowchart TD
    ...
    POM["计划军令反馈<br/>BoardScene + GeneralCommandPanelView<br/>源/目标点 + 进攻箭头/固守环 + 武将/战术/官道受压摘要"]:::ui
...
flowchart TD
    ...
    BOARD["视觉反馈<br/>BoardScene + GeneralCommandPanelView<br/>进攻箭头、防御圆环、武将战术/官道受压摘要、微操单位金色圈"]:::ui
