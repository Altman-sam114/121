...
flowchart TD
    ...
    UCP["军队接战预判<br/>AppContainer.selectedUnitCombatPreviewNotes<br/>最近敌军 + 接近武将 + 接近参考 + 官道接近 + 首选理由 + 接战官道 + 交战武将 + 候选敌将 + 候选武将修正 + 三目标排序 + 敌我余兵 + 目标态势 + 撤退/歼灭风险 + 首选武将影响 + 交战审计"]:::ui
